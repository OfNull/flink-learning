...
public class ContinuousEventTimeTriggerDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //窗口统计
        SingleOutputStreamOperator<Integer> process = streamOperator.keyBy(v -> v.f0)
                .window(TumblingEventTimeWindows.of(Time.of(60, TimeUnit.SECONDS)))
                .trigger(ContinuousEventTimeTrigger.of(Time.of(20, TimeUnit.SECONDS)))
                .process(new ProcessWindowFunction<Tuple2<String, Long>, Integer, String, TimeWindow>() {
                    ...
                    public void process(String s, Context context, Iterable<Tuple2<String, Long>> elements, Collector<Integer> out) throws Exception {
                        ...
                        out.collect(counter);
                        System.out.println("STR 触发提醒：" + context.window().getStart() + " - " + context.window().getEnd() + " key: " + s + "  count: " + counter);
                    }
                });
